...
rego: #tsc > Servo Release Managers and Administrators
...
nico: Could you remind us how much money we have coming in per month? We could compare it to the amount going out.rego: https://servo.org/blog/2025/08/22/this-month-in-servo/#donations
...
martin: I think this is a great idea; about the point that maybe more people will donate if they see we're using the money; we can probably explain what we're using with the money to inspire people keeping donating or to donate morerego: rego: we could do an special blog post
